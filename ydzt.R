...
### 2017年8月25日修订，case1[,7]--case1[,10]，增加此15天和上15天病例数两个变量
...
library(plyr)
ydzt <- function(mdf=mdf,currentdate=Sys.Date()){
    setwd("D:/")
    ...
    for(i in 1:length(count)){
        ...
        case2=subset(case1,as.Date(case1$发病日期)>=(currentdate-15))
        ...
        case3=subset(case1,as.Date(case1$发病日期)>=(currentdate-30)&as.Date(case1$发病日期)<(currentdate-15))
